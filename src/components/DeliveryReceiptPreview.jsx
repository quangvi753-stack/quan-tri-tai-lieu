                    ...
                    <div className="flex justify-between text-center font-bold">
                        ...
                        <div className="w-1/5">
                            ...
                            <div className="h-16 flex items-center justify-center overflow-hidden my-1">
                              {data.signatureA ? (
                                <img src={data.signatureA} alt="Chữ ký Thủ kho" className="max-h-16 object-contain mix-blend-multiply" />
                              ) : (
                                <div className="h-10" />
                              )}
                            </div>
                        ...
                        <div className="w-1/5">
                            ...
                            <div className="h-16 flex items-center justify-center overflow-hidden my-1">
                              {data.signatureB ? (
                                <img src={data.signatureB} alt="Chữ ký Người nhận" className="max-h-16 object-contain mix-blend-multiply" />
                              ) : (
                                <div className="h-10" />
                              )}
                            </div>

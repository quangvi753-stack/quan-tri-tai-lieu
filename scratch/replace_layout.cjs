...
const tabs = [
  { id: 'contract', form: 'ContractForm', data: 'contractData', preview: 'ContractPreview', props: 'onUpdate={handleUpdateContractData}\n                    onUpdateItem={handleUpdateContractItem}\n                    onAddItem={handleAddContractItem}\n                    onRemoveItem={handleRemoveContractItem}\n                    onUpdateClause={handleUpdateContractClause}\n                    onAddClause={handleAddContractClause}\n                    onRemoveClause={handleRemoveContractClause}', exportArg: '`${contractData.documentType === \'appendix\' ? \'PhuLuc\' : \'HopDong\'}_${contractData.id.replace(/\\//g, \'_\')}`' },
  { id: 'delivery', form: 'DeliveryReceiptForm', data: 'deliveryData', preview: 'DeliveryReceiptPreview', props: 'onUpdate={handleUpdateDeliveryData}\n                    onUpdateItem={handleUpdateDeliveryItem}\n                    onAddItem={handleAddDeliveryItem}\n                    onRemoveItem={handleRemoveDeliveryItem}', exportArg: '`PhieuXuatKho_${deliveryData.id}`' },
  { id: 'payment', form: 'PaymentRequestForm', data: 'paymentData', preview: 'PaymentRequestPreview', props: 'onUpdate={handleUpdatePaymentData}\n                    onUpdateItem={handleUpdatePaymentItem}\n                    onAddItem={handleAddPaymentItem}\n                    onRemoveItem={handleRemovePaymentItem}', exportArg: '`DeNghiThanhToan_${paymentData.id}`' },
